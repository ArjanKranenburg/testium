...
import net.sf.testium.TestGroupResultStdOutWriter;
import net.sf.testium.TestRunResultStdOutWriter;
import net.sf.testium.Testium;
import net.sf.testium.configuration.ConfigurationException;
import net.sf.testium.configuration.TestResultInterfaceConfiguration;
import net.sf.testium.configuration.TestResultInterfaceConfigurationXmlHandler;
