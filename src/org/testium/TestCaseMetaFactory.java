...
public class TestCaseMetaFactory implements TestCaseFactory
{
	...
	public TestCaseMetaFactory( Hashtable<String, TestCaseFactory> aTcFactories,
	                            TestStepFactory aStepFactory )
	{
		Trace.println( Trace.CONSTRUCTOR,
		               "TestCaseMetaFactory( " + aTcFactories.size() + " TestCaseFactory, " + aStepFactory,
		               true );
	...
	{
		Trace.println(Trace.SUITE, "create( " + anId + ", " 
					   			  			  + aType + ", "
					   			  			  + aSequence + ", "
